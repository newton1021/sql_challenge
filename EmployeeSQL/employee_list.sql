-- 1. ******************* employee list **************
select emp_id as id, last_name as "last name", first_name as "First Name", sex, s.salary
from employees as em
left join salaries as s on em.emp_id = s.empolyee_id;
...
left join employees as m on dm.employee_id = m.emp_id;


-- 4. ****************** employee and department
select e.emp_id, e.last_name, e.first_name,de.depart_no,d.depart_name
from employees as e
